...
class SlickTablesGeneric(val profile: slick.jdbc.PostgresProfile)(implicit ec: ExecutionContext) {
  ...
  private val dbConfig = DatabaseConfig.forConfig[PostgresProfile]("akka.projection.slick")
  val db               = {
...
object Tables extends SlickTablesGeneric(slick.jdbc.PostgresProfile)(ExecutionContext.parasitic)
