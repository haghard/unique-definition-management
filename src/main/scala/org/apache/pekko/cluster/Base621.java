...
public class Base621 {
  ...
  private Base621(final byte[] alphabet) {
    this.alphabet = alphabet;
    createLookupTable();
  }

  public static Base621 createInstance() {
    return createInstanceWithGmpCharacterSet();
  }

  public static Base621 createInstanceWithGmpCharacterSet() {
    return new Base621(CharacterSets.GMP);
  }

  public static Base621 createInstanceWithInvertedCharacterSet() {
    return new Base621(CharacterSets.INVERTED);
  }
